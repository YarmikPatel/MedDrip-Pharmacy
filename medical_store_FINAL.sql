...
INSERT INTO `cart` (`cart_id`, `uid`, `pid`, `pname`, `image`, `price`, `qty`, `final_order`) VALUES
(2, 3, 53, 'Hair Growth/Hair Growth Syrup', 'height_growth_syrup.jpg', 300, 45, 13500);
...
(58, 1, 'Kids Body Powder', 'Absorbs moisture and prevents skin irriation.', 'Diaper Rash, Skin Chafing.', 'Apply liberally to affected areas as needed.', 30, 255, 'Kids Body Powder.jpg');
...
(2, 'yarmik', 'yarmik kansagara', '$2y$10$jQa5vY8HopEyA', 3725259041, 'y@gmail.com', 'sai devaliya'),
(3, '2', '2', '2', 2222222222, 'a@gmail.com', '1'),
(4, '123', '123', '$2y$10$6jUk.tlFitdKl', 1231231231, 'q@gmail.com', 'sd');
